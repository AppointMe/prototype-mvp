          ...
          AppointMe
            ...
            <div className="hidden md:flex items-center space-x-8">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <LogoutIcon onClick={handleLogout} className="cursor-pointer text-gray-500 hover:text-[#311B92]"/>
                    {/*<button*/}
                    {/*  onClick={handleLogout}*/}
                    {/*  className="ml-2 px-3 py-1 rounded bg-[#311B92] text-white hover:bg-[#4527a0] transition"*/}
                    {/*>*/}
                    {/*  Logout*/}
                    {/*</button>*/}
                </div>
            ...
            {menuOpen && (
                <div
                    className="absolute top-16 left-0 w-full bg-white shadow-md md:hidden flex flex-col items-start p-4 space-y-4 z-50">
